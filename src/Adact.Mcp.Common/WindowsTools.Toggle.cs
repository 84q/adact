...
public sealed partial class WindowsTools
{
    ...
    [McpServerTool(Name = "windows_check")]
        ...
        CancellationToken ct = default)
    {
        ...
        catch (Exception ex) { return MapOrLog(ex, "windows_check"); }
    }
    ...
    /// <param name="ct">キャンセルトークン。</param>
    /// <returns>成功時は空 content。</returns>
    [McpServerTool(Name = "windows_uncheck")]
        ...
        CancellationToken ct = default)
    {
        ...
        catch (Exception ex) { return MapOrLog(ex, "windows_uncheck"); }
    }
    ...
    [McpServerTool(Name = "windows_select")]
        ...
        CancellationToken ct = default)
    {
        ...
        catch (Exception ex) { return MapOrLog(ex, "windows_select"); }
    }
    ...
    /// <param name="ct">キャンセルトークン。</param>
    /// <returns>成功時は空 content。</returns>
    [McpServerTool(Name = "windows_focus")]
        ...
        CancellationToken ct = default)
    {
        ...
        catch (Exception ex) { return MapOrLog(ex, "windows_focus"); }
    }
    ...
    /// <param name="ct">キャンセルトークン。</param>
    /// <returns>成功時は空 content。</returns>
    [McpServerTool(Name = "windows_clear")]
    [Description("Clear the value of an input element (equivalent to windows_fill with an empty string).")]
        ...
        CancellationToken ct = default)
    {
        ...
        catch (Exception ex) { return MapOrLog(ex, "windows_clear"); }
    }
    ...
    [McpServerTool(Name = "windows_scroll_into_view")]
        ...
        CancellationToken ct = default)
    {
        ...
        catch (Exception ex) { return MapOrLog(ex, "windows_scroll_into_view"); }
    }
}
