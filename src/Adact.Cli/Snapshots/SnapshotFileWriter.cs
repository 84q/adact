...
/// <summary>
/// snapshot JSON をファイルに書き出すヘルパ。設計 009 §4.4 / §5.2、011 §4.5。
/// 既定の保存先は <c>.adact/</c>。ファイル名は <c>session-&lt;sid&gt;-&lt;UTC ts&gt;.json</c>。
/// 戻り値は CWD からの相対パス (slash 区切り) で stdout 表示用。
/// </summary>
internal static class SnapshotFileWriter
{
    public static string Write(string snapshotJson, int sid, string? dir = null)
    {
        ...
        var filename = $"session-{sid}-{ts}.json";
